...
def lambda_handler(event, context):
    ...
    <body>
        <div class="container">
            <div class="header">
                <h2>Top 10 Tracks by Interaction</h2>
                <p>Generated Report</p>
            </div>
            <div class="content">
                <p>Hello,</p>
                <p>Below is a summary of the top 10 tracks based on user interactions.</p>
                <table>
                    <thead>
                        <tr>
                            <th>Track Name</th>
    ...
    for track in tracks:
        ...
        total_interactions = track.get('total_interactions', 'N/A')
        body_html += f"""
                        <tr>
                            <td>{track_name}</td>
